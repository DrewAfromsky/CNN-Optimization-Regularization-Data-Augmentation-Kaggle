...
class ImageGenerator(object):
    def __init__(self, x, y):
        ...
        # ImageGenerator instance has to store the following information:
    ...
    def create_aug_data(self):
        # If using the function create_aug_data() to generate new dataset, you can perform the following operations in each
    ...
    def next_batch_gen(self, batch_size, shuffle=True):
        ...
        # Use 'yield' keyword, implement this generator. 
    ...
    def translate(self, shift_height, shift_width):
        ...
        """
        # Use rolling.
        # For example, if you shift 3 pixels to the left, append the left-most 3 columns that are out of boundary to the
    ...
    def flip(self, mode='h'):
        ...
        """
        # Record the boolean values is_horizontal_flip and
        # is_vertical_flip.
    ...
    def add_noise(self, portion, amplitude):
        ...
        """
        # Implement the add_noise function. Record the boolean value is_add_noise.
