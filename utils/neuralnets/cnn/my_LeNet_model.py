...
def my_training(X_train, y_train, X_val, y_val, 
    ...
    print("Building  MyLeNet. Parameters: ")
...
def my_training_task4(X_train, y_train, X_val, y_val, conv_featmap=[6,8],fc_units=[100],
    ...
    translated = gen.translate(5,1)
    rotated = gen.rotate(45)
    noise = gen.add_noise(1,5)
    flipped = gen.flip(mode='v')
    
    
    X_train, y_train = gen.create_aug_data()
    
    
    print("Building  my_LeNet. Parameters: ")
    print("conv_featmap={}".format(conv_featmap))
    print("fc_units={}".format(fc_units))
    print("conv_kernel_size={}".format(conv_kernel_size))
    print("pooling_size={}".format(pooling_size))
